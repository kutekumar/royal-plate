...
const BlogEnhanced = () => {
  ...
  // Track scroll progress with native scroll
  useEffect(() => {
  ...
  const fetchComments = async (postId: string) => {
    try {
      ...
      if (error) {
        ...
        // Transform fallback data to match BlogComment type
        data = fallbackResult.data?.map((comment: any) => ({
          id: comment.id,
          ...
          customer_name: comment.profiles?.full_name || null,
          customer_email: null,
          avatar_url: null,
        })) || [];
  ...
  const PostCard = ({ post, index }: { post: BlogPost; index: number }) => {
    ...
    return (
      <motion.div
        ...
        className="blog-card rounded-3xl bg-white overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 active:scale-[0.98] border border-gray-100/80 group"
      >
        {/* ── Hero Image ── */}
        {post.hero_image_url && (
          <div
            className="blog-image-container relative h-48 overflow-hidden cursor-pointer"
        ...
        {/* ── Comments Section ── */}
          {commentsExpanded && (
            <div
              className="border-t border-gray-100 bg-gray-50/80 p-4 space-y-3 overflow-hidden"
            >
  ...
  const renderPostSkeleton = () => (
    <div className="rounded-3xl bg-white overflow-hidden shadow-sm border border-gray-100/80">
      <div className="h-40 skeleton-luxury" />
  ...
  return (
    <>
      ...
      <div className="relative flex h-screen w-full max-w-md mx-auto flex-col overflow-hidden bg-gradient-to-b from-[#F5F5F7] via-[#FAFAFA] to-[#F0F0F2] font-poppins">
          ...
          <div ref={headerRef} className="glass-header flex items-center justify-between px-5 pt-6 pb-3 z-10">
            <div>
              <h1 className="text-[#1D2956] text-xl font-bold tracking-tight leading-none text-gradient-animated">Updates</h1>
          ...
          {/* ── Search Bar ── */}
          <div ref={searchRef} className="px-5 pb-3 z-10">
            <div className="search-luxury relative">
          ...
          <AnimatePresence>
            {showFilters && (
              <motion.div
                ...
                className="mx-5 mb-3 p-4 glass-card rounded-2xl z-10 overflow-hidden"
              >
          ...
          >
            {loadingPosts ? (
              ...
              <div className="flex flex-col items-center justify-center py-20 text-center">
                <div className="w-20 h-20 rounded-3xl bg-gradient-to-br from-[#536DFE]/10 to-[#1D2956]/10 flex items-center justify-center mb-5 shadow-inner floating">
